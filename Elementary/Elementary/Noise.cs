namespace Elementary
{
    ...
    {
        // All rights belong to @Flafla2

        /// <summary>
        /// Generates perlin noise and gets the value at the specified position
        /// </summary>
        /// <param name="x">The X coordinate</param>
        /// <param name="y">The Y coordinate</param>
        /// <param name="z">The Z coordinate</param>
        /// <param name="octaves">The amount of octaves, number must be equal or above 1</param>
        /// <param name="persistence">The persistence of the noise per octave</param>
        /// <returns>The perlin noise value at the specified position</returns>
        public static double OctavePerlin(double x, double y, double z, int octaves = 1, double persistence = 1.0)
        {
            double total = 0;
            double frequency = 1;
            double amplitude = 1;
        ...
        private static double perlin(double x, double y, double z, double repeat = 0.0)
        {
            if (repeat > 0.0)
